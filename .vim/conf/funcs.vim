...
function! _ruby_head()
  ...
  exe "normal o# author:    QIAO Nan <qiaonancn@gmail.com>"
...
function! _r_head()
  let filename = bufname("%")
  let date = strftime("%Y %b %d")
  exe "normal i#!/usr/bin/env Rscript"
  exe "normal o# -*- coding: UTF-8 -*-"
  exe "normal o#"
  exe "normal o# name:      " . filename
  exe "normal o# author:    QIAO Nan <qiaonancn@gmail.com>"
  ...
  exe "normal o#"
  exe "normal o"
  r ~/.vim/conf/r_example.r
endfunction


"-- add python head --"

function! _python_head()
  let filename = bufname("%")
  let date = strftime("%Y %b %d")
  ...
  exe "normal o#"
  exe "normal o"
  r ~/.vim/conf/argparser_example.py
endfunction
